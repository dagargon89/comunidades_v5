                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <a href="#" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                            ...
                            <span class="text-sm font-medium text-gray-900">Capturar Actividad</span>
                        </a>
                        ...
                        <a href="#" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                            ...
                            <span class="text-sm font-medium text-gray-900">Registrar Métrica</span>
                        </a>
                        ...
                        <a href="#" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                            ...
                            <span class="text-sm font-medium text-gray-900">Subir Archivos</span>
                        </a>
                        ...
                        <a href="#" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                            ...
                            <span class="text-sm font-medium text-gray-900">Ver Historial</span>
                        </a>
                    </div>
                </div>
